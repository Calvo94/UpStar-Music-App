...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ArtistMain = __webpack_require__(21);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ArtistFilter = __webpack_require__(22);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactInputRange = __webpack_require__(26);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _GetAgeRange = __webpack_require__(29);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Artist = __webpack_require__(30);
	...
	module.exports = function () {
	  return Promise.all([Artist.find({}).sort({ age: 1 }).limit(1).then(function (artists) {
	    return artists[0].age;
	  }), Artist.find({}).sort({ age: -1 }).limit(1).then(function (artists) {
	    return artists[0].age;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (criteria, sortProperty) {
	  ...
	  var findcriteria = {};
	  if (criteria.name) {
	    findcriteria.$text = { $search: criteria.name };
	  }
	  if (criteria.age) {
	    findcriteria.age = {
	  ...
	  if (criteria.yearsActive) {
	    findcriteria.yearsActive = {
	      $gte: criteria.yearsActive.min,
	      $lte: criteria.yearsActive.max
	    };
	  }

	  var query = Artist.find(findcriteria).sort(_defineProperty({}, sortProperty, 1)).skip(offset).limit(limit);

	  return Promise.all([query, Artist.find(findcriteria).count()]).then(function (results) {
	    return {
	      all: results[0],
	      count: results[1],
	      offset: offset,
	  ...
	  //$range: [criteria.age.min, age, criteria.age.min],
	  //$range: [criteria.yearsActive.min, yearsActive, criteria.yearsActive.min] })
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (_id) {
	  ...
	  //return Artist.findOneAndRemove({_id});
